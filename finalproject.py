...
ourworld_vaccinatedrate = pd.read_csv('vac.csv')
...
plt.plot(ourworld_dailyvac.Day.iloc[28517:28534],ourworld_dailyvac.new_vaccinations_smoothed_per_million.iloc[28517:28534])
plt.title("new_vaccinations_per_million(Olympics Games)")
plt.xlabel("date")
plt.ylabel("new_vaccinations_per_million")
